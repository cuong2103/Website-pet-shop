      ...
      <div class="row">
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm thú cưng mới</h3>
              </div>
              ...
              <form action="<?= BASE_URL_ADMIN . '?act=them-san-pham' ?>" method="POST" enctype="multipart/form-data">
                <div class="row card-body">
                  <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" name="ten_san_pham" placeholder="Nhập tên thú cưng">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control" name="so_luong" placeholder="Nhập số lượng thú cưng">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="date" class="form-control" name="ngay_nhap" placeholder="Ngày nhập thú cưng">
                  ...
                  <div class="form-group col-6">
                    ...
                    <select class="form-control" name="trang_thai" id="exampleFormControlSelect1">
                      <option value="" selected disabled>Chọn trạng thái sản phẩm</option>
