...
<head>
    ...
    <script data-cfasync="false" nonce="d291af18-81fc-48be-b966-d50853588973">
        try {
            (function(w, d) {
                ! function(fv, fw, fx, fy) {
                    if (fv.zaraz) console.error("zaraz is loaded twice");
                        ...
                        fv.zaraz._v = "5858";
                        fv.zaraz._n = "d291af18-81fc-48be-b966-d50853588973";
                        fv.zaraz.q = [];
                ...
                <?php if (isset($_SESSION['error'])) { ?>
                    <?php if (is_array($_SESSION['error'])) { ?>
                        <?php foreach ($_SESSION['error'] as $err) { ?>
                            <p class="text-danger login-box-msg"><?= htmlspecialchars($err) ?></p>
                        <?php } ?>
                    <?php } else { ?>
