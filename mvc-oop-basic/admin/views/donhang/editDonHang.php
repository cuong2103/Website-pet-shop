          ...
          <div class="card card-primary">
            ...
            <form action="<?= BASE_URL_ADMIN . '?act=sua-don-hang' ?>" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control" name="email_nguoi_nhan" value="<?= $donHang['email_nguoi_nhan'] ?>" placeholder="Nhập địa chỉ">
                ...
                <div class="form-group">
                  <label>Ghi chú</label>
                  <textarea name="ghi_chu" class="form-control" placeholder="Nhập ghi chú"><?= $donHang['ghi_chu'] ?>
                    </textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select id="trang_thai_id" class="form-control custom-select" name="trang_thai_id">
                    <?php foreach ($listTrangThaiDonHang as $trangThai): ?>
                      <option
                        <?php
                       if(
                        $donHang['trang_thai_id'] != $trangThai['id'] && 
                        ($donHang['trang_thai_id'] > $trangThai['id'] || in_array($donHang['trang_thai_id'], [8,9,10]))
                    ){
                        echo 'disabled';
                    } ?>
