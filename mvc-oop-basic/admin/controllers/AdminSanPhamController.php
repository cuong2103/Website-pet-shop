...
class AdminSanPhamController{
    ...
    public function formAddSanpham(){
        ...
        deleteSessionError(); // Xóa session error sau khi hiển thị form
    }
    ...
    public function postAddSanpham(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $file_thum = uploadFile($hinh_anh, 'uploads/');
    ...
    public function formEditSanPham(){
        //Dùng để hiển thị form nhập
        // Lấy ra thông tin sản phmar cần sửa
        $id = $_GET['id_san_pham'];
    ...
    public function postEditSanpham(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $old_file = $SanPhamOld['hinh_anh']; // Lấy hình ảnh cũ của sản phẩm
            ...
            if(isset($hinh_anh) && $hinh_anh['error'] == UPLOAD_ERR_OK){
                // Nếu có hình ảnh mới thì upload và lấy đường dẫn
                $new_file = uploadFile($hinh_anh, './uploads/');

                if(!empty($old_file)) {
                    deleteFile($old_file); // Xóa file cũ nếu có
                }
            } else {
