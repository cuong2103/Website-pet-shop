                            ...
                            <div class="col-lg-5">
                                <div class="product-large-slider">
                                    <?php foreach ($listAnhSanPham as $key => $anhSanPham): ?>
                                        <div class="pro-large-img" style="width:250px; height:250px; overflow:hidden; margin:0 auto;">
                                            <img src="<?= BASE_URL . $anhSanPham['link_hinh_anh'] ?>" alt="product-details" style="width:100%; height:100%; object-fit:cover; display:block;">
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                                <div class="pro-nav slick-row-10 slick-arrow-style">
                                    <?php foreach ($listAnhSanPham as $key => $anhSanPham): ?>
                                        <div class="pro-nav-thumb" style="width:250px; height:100px; overflow:hidden; margin:0 auto;">
                                            <img src="<?= BASE_URL . $anhSanPham['link_hinh_anh'] ?>" alt="product-details" style="width:100%; height:100%; object-fit:cover; display:block;">
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            ...
                            <div class="col-lg-7">
                                <div class="product-details-des">
                                    ...
                                    <div class="availability">
                                        ...
                                        <span><?= 'Số lượng còn lại ' . $sanPham['so_luong'] ?></span>
                                    </div>
                                    <p class="pro-desc">
                                        <?= $sanPham['mo_ta'] ?>
                                    </p>
