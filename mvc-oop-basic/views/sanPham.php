            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        <h2 class="title">Sản phẩm chó</h2>
                        <p class="sub-title">Tất cả sản phẩm thuộc danh mục chó</p>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="product-item">
                            <figure class="product-thumb" style="width:250px; height:250px; overflow:hidden; margin:0 auto;">
                                <a href="<?= BASE_URL . '?act=chi-tiet-san-pham&id_san_pham=' . $sanPham['id']; ?>">
                                    <img class="pri-img" src="<?= BASE_URL . $sanPham['hinh_anh'] ?>" alt="<?= $sanPham['ten_san_pham'] ?>" style="width:100%; height:100%; object-fit:cover; display:block;">
