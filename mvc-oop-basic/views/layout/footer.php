        ...
        <div class="footer-top section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <p>Chào mừng bạn đến với shop thú cưng nơi cung cấp cho bạn các thú cưng mới và giá cả rất ưu đãi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            <h6 class="widget-title">Theo dõi tin tức mới nhất</h6>
                ...
                <div class="row align-items-center mt-20">
                    <div class="col-md-6">
                        <div class="newsletter-wrapper">
                            <h6 class="widget-title-text">Đăng kí nhận thông tin</h6>
                            <form class="newsletter-inner" id="mc-form">
                                <input type="email" class="news-field" id="mc-email" autocomplete="off" placeholder="Nhập email của bạn" required>
                                <button class="news-btn" id="mc-submit">Gữi</button>
                            </form>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2025 <b>Shop Thú Cưng</b> Made with <i class="fa fa-heart text-danger"></i> by <b>Nguyễn Đăng Cường</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
