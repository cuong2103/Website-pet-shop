                                    ...
                                    <nav class="desktop-menu">
                                        <ul>
                                            ...
                                            <li><a href="#">Sản phẩm <i class="fa fa-angle-down"></i></a>
                                                <ul class="dropdown">
                                                    <li><a href="<?= BASE_URL . '?act=san-pham-cho' ?>">Chó</a></li>
                                                    <li><a href="<?= BASE_URL . '?act=san-pham-meo' ?>">Mèo</a></li>
                                                </ul>
                                            </li>
                                ...
                                <div class="header-configure-area">
                                    <ul class="nav justify-content-end">
                                        ...
                                        <li class="user-hover">
                                            ...
                                            <?php } else { ?>
                                                <li><a href="<?= BASE_URL . '?act=form-sua-thong-tin-ca-nhan' ?>">Tài khoản cá nhân</a></li>
