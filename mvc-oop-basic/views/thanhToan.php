            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="checkoutaccordion" id="checkOutAccordion">
                        <div class="card">
                            <h6>Bạn có mã giảm giá không? <span data-bs-toggle="collapse" data-bs-target="#couponaccordion">Click
                        ...
                        <div class="billing-form-wrap">
                            <form action="#">
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="tel" name="sdt_nguoi_nhan" id="sdt_nguoi_nhan" value="<?= $user['so_dien_thoai'] ?>" placeholder="SĐT người nhận" required />
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <a href="product-details.html"><?= $sanPham['ten_san_pham'] ?> <strong> × <?= $sanPham['so_luong'] ?></strong></a>
                                                </td>
                                                <td>
                                                    <?php
                                                    $tongTien = 0;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td>Tổng sản phẩm</td>
                                            <td><strong><?= formmatPrice($tongGioHang) ?></strong></td>
                                        </tr>
                                        <tr>
                                            <td>Shipping</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong><?= formmatPrice($tongGioHang + 40000) ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <div class="order-payment-method">
                                <div class="single-payment-method show">
                                    ...
                                    <div class="payment-method-details" data-method="cash">
                                        <p>Khách hàng có thể thanh toán khi nhận được hàng(Cần xác nhận đơn hàng).</p>
                                    </div>
                                </div>
                                <div class="single-payment-method">
                                    ...
                                    <div class="payment-method-details" data-method="bank">
                                        <p>Khách hàng có thể thanh toán trực tuyến</p>
                                    </div>
                                </div>
